...
Card.create(title: "My Card1", list_id: l1.id, description: "summary", labels: ['red', 'purple'], comments_count: 2)
Card.create(title: 'My Card2', list_id: l1.id, description: 'summary', comments_count: 1)
